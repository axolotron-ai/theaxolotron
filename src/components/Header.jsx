...
export default function Header() {
    ...
    return (
        <div className="flex items-center justify-between p-[20px] bg-black/30 w-[85%] mx-auto fixed inset-0 z-50 h-[55px] md:h-[60px] rounded-full top-[35px] backdrop-blur-3xl">
            <a href="/" className="w-full flex items-center justify-center lg:justify-start"><Image src="/axolotron-logo.png" alt="axolotron-logo" height={50} width={50} quality={100} className="h-[16px] w-[150px]" /></a>
