    ...
    return (
        <>
            <div className="bg-black/85 min-h-screen">
                <p className="text-white text-[clamp(1.25rem,2.25vw,2.25rem)] font-semibold py-[50px] mx-[calc(8%)]">Ecommerce</p>
                <div className="sm:grid sm:grid-cols-3 flex flex-col mx-[calc(10%)] gap-[30px]">
